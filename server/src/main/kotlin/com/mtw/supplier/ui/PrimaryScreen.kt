...
class StatsFragment(val width: Int, val height: Int, positionX: Int, positionY: Int): Fragment {
    ...
    init {
        ...
        val leftLabel = Components.label()
            ...
            .withPosition(1, 0)
            .build()
        val rightLabel = Components.label().withText("Nightmare")
            .withPosition(width - "Dream".length - "Nightmare".length - 2, 0)
        ...
        val historyHeader = Components.header().withText("Last seen:").build()
